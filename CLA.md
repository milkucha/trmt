...
> **Note on acceptance:** Physical signature is not required. Acceptance of this Agreement is
> made by posting the statement specified in [CONTRIBUTING.md](CONTRIBUTING.md) as a comment
> in your pull request. That comment, tied to your verified GitHub identity and timestamped,
> constitutes your signature for the purposes of this Agreement.

---

Thank you for your interest in contributing to The Roads More Travelled (TRMT) ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us.
Acceptance is made by following the instructions in [CONTRIBUTING.md](CONTRIBUTING.md).
...
contact Us at milkucha@disroot.org before submitting.
...
otherwise transfer the Contribution and the Contribution in combination with the Material (and portions
of such combination). This license is granted only to the extent that the exercise of the licensed rights
infringes such patent claims; and provided that this license is conditioned upon compliance with
Section 2.3.
...
In addition, We may use the following licenses for Media in the Contribution: CC BY-NC 4.0, or any
successor version of that license (including any right to adopt any future version of a license if
permitted).

### 2.4 Moral Rights

If moral rights apply to the Contribution, to the maximum extent permitted by law, You waive and
agree not to assert such moral rights against Us or our successors in interest, or any of our licensees,
...
(d) You have contacted Us at milkucha@disroot.org before submitting, if You do not own the
...
> **For contributors:** You do not sign this document manually. Post the acceptance statement in your
> pull request as described in [CONTRIBUTING.md](CONTRIBUTING.md). That acts as your signature.
...
Contact: milkucha@disroot.org

Project: The Roads More Travelled (TRMT) — https://github.com/milkucha/TRMT

---

*This agreement is based on the Harmony Individual Contributor License Agreement (HA-CLA-I)
Version 1.0, July 4, 2011, licensed under Creative Commons Attribution 3.0 Unported.*
